        ...
        <div className="relative bg-primary overflow-hidden flex flex-col items-center gap-2 md:pt-[52px] pt-6 min-h-[680px] pb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 relative z-10 w-full inset-0">
                ...
                <div className="w-full md:h-[445px] sm:h-[350px] h-[300px] overflow-hidden">
                    <Image src="/family1.jpeg" alt="Family 1" width={867} height={1300} className="w-full h-full object-cover object-top" />
                </div>
                <div className="w-full md:h-[445px] sm:h-[350px] h-[300px] overflow-hidden">
                    <Image src="/family2.jpeg" alt="Family 2" width={867} height={1300} className="w-full h-full object-cover " />
                </div>
                <div className="w-full md:h-[445px] sm:h-[350px] h-[300px] overflow-hidden">
                    <Image src="/family3.jpeg" alt="Family 3" width={1880} height={1253} className="w-full h-full object-cover object-top" />
                </div>
                <div className="w-full md:h-[445px] sm:h-[350px] h-[300px] overflow-hidden">
                    <Image src="/family4.jpeg" alt="Family 4" width={867} height={1300} className="w-full h-full object-cover md:object-bottom object-center" />
                </div>
