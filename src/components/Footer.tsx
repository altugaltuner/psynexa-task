...
const Footer = () => {
    return (
        <footer className="bg-black text-white pt-12 pb-[148px] px-8 lg:px-16 font-clash">
            <div className=" flex md:flex-row flex-col lg:gap-28 md:gap-14 gap-7 md:items-start items-center min-h-[350px]">
                ...
                <div className='flex flex-col w-full md:w-1/2 gap-[26px] md:items-start items-center'>
                    <img src="/thisuix.png" alt="" className='w-[154px] h-[54px]' />
                    ...
                    <div>
                        ...
                        <form className="flex items-center text-black overflow-hidden relative">
                            <input
                                ...
                                className="min-h-[74px] px-4 py-2 w-full focus:outline-none text-base font-bold bg-[#FFFFFF21] border border-white border-opacity-65 rounded-lg text-white placeholder-white placeholder:font-bold placeholder:text-[14px] font-cabinet"
                            />
                            <button type="submit" className="bg-[#5DBE8C] absolute sm:w-[54px] sm:h-[54px] w-[35px] h-[35px] shadow-[0px_8px_21px_0px_#E8752529] rounded-lg right-[2%] flex justify-center items-center">
            ...
            {/* Alt Kısım */}
            <div className="mt-[72px] text-center font-bold sm:text-xl text-base font-cabinet">
