...
const HeroSection = () => {
    return (
        <section className="relative bg-black text-white">
            ...
            ></div>
            <div className='flex justify-end z-10 relative md:pt-6 pt-2'><img src="/menu.png" alt="menu" className='md:mr-[123px] sm:mr-[50px] mr-[30px]' /></div>
            <div className="relative z-10 w-full flex flex-col-reverse md:flex-row items-center justify-between">

                {/* Left Side */}
                <div className="w-full lg:w-1/2 flex text-left gap-[25px] items-center justify-center">
                    <img src="/pink-logo1.png" alt="pink-logo" className='lg:h-[389px] h-[250px] hidden md:block' />
                    <div className='flex flex-col sm:gap-9 gap-5 sm:w-auto w-[80%] md:pb-10 pb-4'>
                        <div className='flex flex-col items-center md:items-start'>
                            ...
                            <p className="font-corinthia text-[40px]  xl:text-[110px] lg:[70px] md:[text-60px] sm:text-[50px] leading-none font-normal">I’m James</p>
                            ...
                            <p className=" xl:text-[42px] lg:text-[28px] md:text-[24px] sm:text-[20px] sm:text-base md:leading-[52px] sm:leading-10 leading-8 font-normal font-clash text-center">
                        ...
                        <div className="flex gap-[18px] lg:flex-row flex-col md:mb-0 mb-2 md:items-start items-center">
                            <button className="bg-accent flex justify-center items-center text-black rounded-lg font-medium shadow-custom-inset text-lg md:w-[240px] md:h-[60px] sm:w-[200px] sm:h-[55px] w-[180px] h-[50px] font-clash relative ">
                            ...
                            <button className="bg-secondary text-black px-4 py-2 rounded-lg font-medium shadow-custom-inset w-[200px] font-clash md:h-[60px] sm:h-[55px] h-[50px]"><b>SEE</b> portfolio</button>
                        </div>
                    </div>
                ...
                <div className="w-full h-full lg:w-1/2 flex items-center justify-center mb-8 md:mb-[0px] relative sm:h-[400px] font-clash">
                    ...
                    <div className='flex justify-center h-full w-full'>
                        ...
                        <div className="items-center absolute md:top-[215px] md:right-[10px] lg:top-[200px] lg:right-[40px] bg-white  md:w-[170px] w-[148px] md:h-[48px] h-[48px] rounded-r-[22px] rounded-tl-[22px] shadow-custom-inset justify-center hidden md:flex">
                            <p className='font-semibold md:text-base text-sm leading-6 text-[#252534]'>Data Analysis</p>
                        </div>
                        <div className="flex items-center absolute xl:bottom-[-80px] xl:left-[65px] bottom-[-80px] left-[65px] bg-white text-[#252534] xl:w-[212px] xl:h-[64px] w-[200px] h-[48px] rounded-l-[22px] rounded-br-[0px] rounded-tr-[22px] shadow-custom-inset justify-center hidden md:flex">
